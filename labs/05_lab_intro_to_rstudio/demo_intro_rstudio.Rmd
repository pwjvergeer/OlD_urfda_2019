...
If login fails, sent me an email, I will reset you account for you
...
Much like in the import function from Excel you will see a preview of the datatable. 

In the bottom right corner the appropriate R code is displayed. 
