...
```{r, getting_absolute}
wd <- getwd()
file_path <- file.path(wd, "data", "allijn.tsv")
file_path
```
...
```{r, file_path_example}
path_to_allijn <- file.path(root, "data", "allijn.tsv")
allijn <- read_tsv(path_to_allijn, comment = "#")
```
...
## How can we fix the `Date` variable?
